...
public class AdministCodeRecptnDAO extends EgovComAbstractDAO {
	...
	public void insertAdministCode(AdministCodeRecptn administCodeRecptn) throws Exception {
		AdministCodeRecptn beforeData = (AdministCodeRecptn) selectByPk("AdministCodeRecptnDAO.selectAdministCodeDetail", administCodeRecptn);
	...
	public AdministCodeRecptn selectAdministCodeDetail(AdministCodeRecptn administCodeRecptn) throws Exception {
		return (AdministCodeRecptn) selectByPk("AdministCodeRecptnDAO.selectAdministCodeDetail", administCodeRecptn);
	}
    ...
    public int selectAdministCodeRecptnListTotCnt(AdministCodeRecptnVO searchVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("AdministCodeRecptnDAO.selectAdministCodeRecptnListTotCnt", searchVO);
    }
    ...
    public int selectAdministCodeListTotCnt(AdministCodeRecptnVO searchVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("AdministCodeRecptnDAO.selectAdministCodeListTotCnt", searchVO);
    }
}
