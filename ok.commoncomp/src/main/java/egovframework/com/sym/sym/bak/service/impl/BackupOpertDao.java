...
public class BackupOpertDao extends EgovComAbstractDAO {
	...
	public BackupOpert selectBackupOpert(BackupOpert backupOpert)
	  throws Exception{
		BackupOpert result = (BackupOpert)selectByPk("BackupOpertDao.selectBackupOpert", backupOpert);
		// 스케줄요일정보를 가져온다. 
	...
	public int selectBackupOpertListCnt(BackupOpert searchVO)
	  throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("BackupOpertDao.selectBackupOpertListCnt", searchVO);
	}
