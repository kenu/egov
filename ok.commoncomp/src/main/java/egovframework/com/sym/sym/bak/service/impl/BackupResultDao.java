...
public class BackupResultDao extends EgovComAbstractDAO {
	...
	public BackupResult selectBackupResult(BackupResult backupResult)
	  throws Exception{
		return (BackupResult)selectByPk("BackupResultDao.selectBackupResult", backupResult);
	}
	...
	public int selectBackupResultListCnt(BackupResult searchVO)
	  throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("BackupResultDao.selectBackupResultListCnt", searchVO);
	}
