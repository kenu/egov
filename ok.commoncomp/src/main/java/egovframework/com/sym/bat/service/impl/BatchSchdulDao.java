...
public class BatchSchdulDao extends EgovComAbstractDAO {
	...
	public BatchSchdul selectBatchSchdul(BatchSchdul batchSchdul)
	  throws Exception{
		BatchSchdul result = (BatchSchdul)selectByPk("BatchSchdulDao.selectBatchSchdul", batchSchdul);
		// 스케줄요일정보를 가져온다. 
	...
	public int selectBatchSchdulListCnt(BatchSchdul searchVO)
	  throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("BatchSchdulDao.selectBatchSchdulListCnt", searchVO);
	}
