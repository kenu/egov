...
public class BatchOpertDao extends EgovComAbstractDAO {
	...
	public BatchOpert selectBatchOpert(BatchOpert batchOpert)
	  throws Exception{
		return (BatchOpert)selectByPk("BatchOpertDao.selectBatchOpert", batchOpert);
	}
	...
	public int selectBatchOpertListCnt(BatchOpert searchVO)
	  throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("BatchOpertDao.selectBatchOpertListCnt", searchVO);
	}
