...
public class EgovMemoReprtController {
	...
	public String updateMemoReprt(final MultipartHttpServletRequest multiRequest, Map commandMap, @ModelAttribute("memoReprtVO") MemoReprtVO memoReprtVO, BindingResult bindingResult, ModelMap model) throws Exception{
    	LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
		Boolean isAuthenticated = EgovUserDetailsHelper.isAuthenticated();
