...
public class CnsltManageDAO extends EgovComAbstractDAO {
    ...
    public CnsltManageVO selectCnsltListDetail(CnsltManageVO vo) throws Exception {
        ...
        return (CnsltManageVO) selectByPk("CnsltManageDAO.selectCnsltListDetail", vo);
    ...
    public int selectCnsltListTotCnt(CnsltManageDefaultVO searchVO) {
        ...
        return (Integer)getSqlMapClientTemplate().queryForObject("CnsltManageDAO.selectCnsltListTotCnt", searchVO);
    ...
    public int selectCnsltPasswordConfirmCnt(CnsltManageVO vo) {
        ...
        return (Integer)getSqlMapClientTemplate().queryForObject("CnsltManageDAO.selectCnsltPasswordConfirmCnt", vo);
    ...
    public CnsltManageVO selectCnsltAnswerListDetail(CnsltManageVO vo) throws Exception {
        ...
        return (CnsltManageVO) selectByPk("CnsltManageDAO.selectCnsltAnswerListDetail", vo);
    ...
    public int selectCnsltAnswerListTotCnt(CnsltManageDefaultVO searchVO) {
        ...
        return (Integer)getSqlMapClientTemplate().queryForObject("CnsltManageDAO.selectCnsltAnswerListTotCnt", searchVO);
