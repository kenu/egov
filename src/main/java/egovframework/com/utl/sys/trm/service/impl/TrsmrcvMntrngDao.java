...
public class TrsmrcvMntrngDao extends EgovComAbstractDAO {
	...
	public TrsmrcvMntrng selectTrsmrcvMntrng(TrsmrcvMntrng trsmrcvMntrng)
	  throws Exception{
		return (TrsmrcvMntrng)selectByPk("TrsmrcvMntrngDao.selectTrsmrcvMntrng", trsmrcvMntrng);
	}
	...
	public TrsmrcvMntrngLog selectTrsmrcvMntrngLog(TrsmrcvMntrngLog trsmrcvMntrngLog)
	  throws Exception{
		return (TrsmrcvMntrngLog)selectByPk("TrsmrcvMntrngDao.selectTrsmrcvMntrngLog", trsmrcvMntrngLog);
	}
	...
	public int selectTrsmrcvMntrngListCnt(TrsmrcvMntrng searchVO)
	  throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("TrsmrcvMntrngDao.selectTrsmrcvMntrngListCnt", searchVO);
	}
	...
	public int selectTrsmrcvMntrngLogListCnt(TrsmrcvMntrngLog searchVO)
	  throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("TrsmrcvMntrngDao.selectTrsmrcvMntrngLogListCnt", searchVO);
	}
	...
	public int selectCntcListCnt(CntcVO searchVO)
	  throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("TrsmrcvMntrngDao.selectCntcListCnt", searchVO);
	}
