...
public class BatchResultDao extends EgovComAbstractDAO {
	...
	public BatchResult selectBatchResult(BatchResult batchResult)
	  throws Exception{
		return (BatchResult)selectByPk("BatchResultDao.selectBatchResult", batchResult);
	}
	...
	public int selectBatchResultListCnt(BatchResult searchVO)
	  throws Exception{
		return (Integer)getSqlMapClientTemplate().queryForObject("BatchResultDao.selectBatchResultListCnt", searchVO);
	}
