...
public class InsttCodeRecptnDAO extends EgovComAbstractDAO {
	...
	public void insertInsttCode(InsttCodeRecptn insttCodeRecptn) throws Exception {
		InsttCodeRecptn beforeData = (InsttCodeRecptn) selectByPk("InsttCodeRecptnDAO.selectInsttCodeDetail", insttCodeRecptn);
	...
	public InsttCodeRecptn selectInsttCodeDetail(InsttCodeRecptn insttCodeRecptn) throws Exception {
		return (InsttCodeRecptn) selectByPk("InsttCodeRecptnDAO.selectInsttCodeDetail", insttCodeRecptn);
	}
    ...
    public int selectInsttCodeRecptnListTotCnt(InsttCodeRecptnVO searchVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("InsttCodeRecptnDAO.selectInsttCodeRecptnListTotCnt", searchVO);
    }
    ...
    public int selectInsttCodeListTotCnt(InsttCodeRecptnVO searchVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("InsttCodeRecptnDAO.selectInsttCodeListTotCnt", searchVO);
    }
}
