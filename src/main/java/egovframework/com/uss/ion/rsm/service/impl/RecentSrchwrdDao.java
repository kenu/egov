...
public class RecentSrchwrdDao extends EgovComAbstractDAO {
    ...
    public List selectRecentSrchwrdList(RecentSrchwrd searchVO) throws Exception {
        return (List)list("RecentSrchwrd.selectRecentSrchwrd", searchVO);
    }
    ...
    public int selectRecentSrchwrdListCnt(RecentSrchwrd searchVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("RecentSrchwrd.selectRecentSrchwrdCnt", searchVO);
    }
    ...
    public RecentSrchwrd selectRecentSrchwrdDetail(RecentSrchwrd recentSrchwrd) throws Exception {
        return (RecentSrchwrd)getSqlMapClientTemplate().queryForObject("RecentSrchwrd.selectRecentSrchwrdDetail", recentSrchwrd);
    }
    ...
    public List selectRecentSrchwrdResultInquire(RecentSrchwrd recentSrchwrd) throws Exception {
        return (List)list("RecentSrchwrd.selectRecentSrchwrdResultInquire", recentSrchwrd);
    }    
    ...
    public List selectRecentSrchwrdResultList(RecentSrchwrd searchVO) throws Exception {
        return (List)list("RecentSrchwrd.selectRecentSrchwrdResult", searchVO);
    }
    ...
    public int selectRecentSrchwrdResultListCnt(RecentSrchwrd searchVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("RecentSrchwrd.selectRecentSrchwrdCntResult", searchVO);
    }
