...
public class WikiBookmarkDao extends EgovComAbstractDAO {
	...
	public List selectWikiBookmarkList(WikiBookmark wikiBookmark) throws Exception{
		return (List)list("WikiBookmark.selectWikiBookmarkList", wikiBookmark);
	}
    ...
    public int selectWikiBookmarkDuplicationCnt(WikiBookmark wikiBookmark) throws Exception{
    	return (Integer)getSqlMapClientTemplate().queryForObject("WikiBookmark.selectWikiBookmarkDuplicationCnt", wikiBookmark);
    }
    ...
    public int selectWikiBookmarkListCnt(WikiBookmark wikiBookmark) throws Exception{
    	return (Integer)getSqlMapClientTemplate().queryForObject("WikiBookmark.selectWikiBookmarkListCnt", wikiBookmark);
    }
    ...
    public String selectWikiBookmarkEmpUniqId(WikiBookmark wikiBookmark) throws Exception{
    	return (String)getSqlMapClientTemplate().queryForObject("WikiBookmark.selectWikiBookmarkEmpUniqId", wikiBookmark);
    }
