...
public class EventCmpgnDao extends EgovComAbstractDAO {
	...
	public List selectEventCmpgnList(ComDefaultVO searchVO){
		return (List)list("EventCmpgn.selectEventCmpgn", searchVO);
	}
	...
	public List selectEventCmpgnDetail(EventCmpgnVO eventCmpgnVO){
		return (List)list("EventCmpgn.selectEventCmpgnDetail", eventCmpgnVO);
	}
	...
	public int selectEventCmpgnListCnt(ComDefaultVO searchVO){
		return (Integer)getSqlMapClientTemplate().queryForObject("EventCmpgn.selectEventCmpgnCnt", searchVO);
	}
	...
	public List selectTnextrlHrInfoList(ComDefaultVO searchVO){
		return (List)list("EventCmpgn.selectTnextrlHrInfo", searchVO);
	}
	...
	public List selectTnextrlHrInfoDetail(TnextrlHrInfoVO TnextrlHrInfo){
		return (List)list("EventCmpgn.selectTnextrlHrInfoDetail", TnextrlHrInfo);
	}
	...
	public int selectTnextrlHrInfoListCnt(ComDefaultVO searchVO){
		return (Integer)getSqlMapClientTemplate().queryForObject("EventCmpgn.selectTnextrlHrInfoCnt", searchVO);
	}
