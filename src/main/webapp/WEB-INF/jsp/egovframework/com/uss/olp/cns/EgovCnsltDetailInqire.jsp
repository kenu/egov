...
<caption>상담 상세조회</caption>
  ...
  <tr>
    ...
    <td width="80%" nowrap>
      <textarea name="cnsltCn" class="textarea_readonly"  cols="300" rows="15"  style="width:450px;" readonly title="상담내용"><c:out value="${result.cnsltCn}"/>
      </textarea>
    </td>
  </tr>
...
<c:if test="${result.qnaProcessSttusCode == '3'}">
  <tr>
    ...
    <td width="80%" nowrap>
      <textarea name="managtCn" class="textarea"  cols="300" rows="15"  style="width:450px;" readonly title="답변내용"><c:out value="${result.managtCn}"/>
      </textarea>
    </td>
  </tr>
