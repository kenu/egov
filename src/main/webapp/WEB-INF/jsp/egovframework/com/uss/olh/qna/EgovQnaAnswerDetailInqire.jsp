...
<table width="98%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="Q&amp;A에 대한 답변을 조회합니다.">
  ...
  <tr> 
    ...
    <td width="80%" nowrap>    
      <textarea name="qestnCn" class="textarea"  cols="300" rows="15"  style="width:450px;" readonly title="질문내용"><c:out value="${result.qestnCn}"/>
      </textarea>                       
    </td>
  </tr> 
...
<c:if test="${result.qnaProcessSttusCode == '3' || result.answerCn != null}">
  <tr> 
    ...
    <td width="80%" nowrap>    
      <textarea name="answerCn" class="textarea"  cols="300" rows="15"  style="width:450px;" readonly title="답변내용"><c:out value="${result.answerCn}"/>
      </textarea>                                        
    </td>
  </tr> 
